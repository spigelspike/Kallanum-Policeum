...
export default function HomeScreen() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-slate-950 pb-16 md:pb-0">
      ...
      {/* Developer Footer */}
      <div className="absolute bottom-[80px] md:bottom-4 left-0 right-0 z-40 flex flex-col items-center justify-center pointer-events-none">
        <div className="flex flex-col items-center gap-2 pointer-events-auto bg-black/30 md:bg-transparent backdrop-blur-sm md:backdrop-blur-none px-4 py-2 rounded-2xl md:rounded-none">
