...
export default function HomeScreen() {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden overflow-y-auto bg-slate-950 pb-16 md:pb-0">
      ...
      {/* --- Backgrounds --- */}
      <div
        className="hidden md:block fixed inset-0 bg-cover bg-center bg-no-repeat z-0 opacity-80"
        style={{ backgroundImage: `url(${mainMenuDesktopBg})` }}
      />
      <div
        className="md:hidden fixed inset-0 bg-cover bg-center bg-no-repeat z-0 opacity-80"
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-between py-8 px-4 sm:px-6 md:py-12 md:px-8">
        ...
        {/* Absolute Chai Button (Pill) */}
        <div className="absolute top-4 right-4 z-50">
          <button 
            onClick={() => { playClick(); setShowChaiModal(true) }}
            className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-black/50 backdrop-blur-md border border-[#c89f59]/50 hover:bg-black/70 transition-all text-[#c89f59] hover:text-[#ffe58f] shadow-[0_0_10px_rgba(200,159,89,0.2)] group"
            title="Buy the Developer a Chai"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="font-serif text-[10px] sm:text-xs font-bold tracking-wider uppercase">Buy Me a Chai</span>
          </button>
        </div>
        ...
        <div className={`w-full max-w-lg flex flex-col items-center justify-between min-h-[calc(100vh-100px)] ${mobileTab !== 'play' ? 'hidden md:flex' : 'flex'}`}>
          ...
          {/* Bottom Container for Actions & Footer */}
          <div className="w-full flex flex-col items-center pb-6 md:pb-4">
            {/* Bottom Actions Area */}
            ...
            {/* Developer Footer */}
            <div className="mt-8 flex flex-col items-center gap-3 animate-in fade-in duration-1000 delay-300">
              <span className="text-[10px] font-serif text-[#c89f59]/70 tracking-widest uppercase">
                Developed by Mohamed Shereef
              </span>
              <div className="flex items-center gap-5">
                <a href="https://github.com/spigelspike" target="_blank" rel="noopener noreferrer" className="text-[#c89f59]/70 hover:text-[#ffe58f] transition-colors hover:scale-110 transform" title="GitHub">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.831.092-.646.35-1.086.636-1.336-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.268 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.026 2.747-1.026.546 1.379.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.163 22 16.418 22 12c0-5.523-4.477-10-10-10z"/>
                  </svg>
                </a>
                <a href="https://www.linkedin.com/in/mohamed-shereef-092a82254" target="_blank" rel="noopener noreferrer" className="text-[#c89f59]/70 hover:text-[#ffe58f] transition-colors hover:scale-110 transform" title="LinkedIn">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/mhdshareef._/" target="_blank" rel="noopener noreferrer" className="text-[#c89f59]/70 hover:text-[#ffe58f] transition-colors hover:scale-110 transform" title="Instagram">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
